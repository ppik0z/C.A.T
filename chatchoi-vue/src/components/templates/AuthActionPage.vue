  ...
  >
    ...
    >
      <div class="mb-6 text-center">
        <RouterLink
          class="mb-2 inline-block text-3xl font-bold text-primary focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary"
          to="/"
          >CHATCHOI</RouterLink
        >
        <h1 :id="headingId" class="text-xl font-bold text-on-surface">
          {{ title }}
        </h1>
